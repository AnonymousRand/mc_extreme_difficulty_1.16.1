...
import AnonymousRand.anonymousrand.plugin.nms.customentities.mobs.CustomEntityChickenAggressive;
...
import AnonymousRand.anonymousrand.plugin.nms.customentities.mobs.CustomEntityZombieVillager;
...
public class ListenerMobDamage implements Listener {
    ...
    public void entityDamageByEntity(EntityDamageByEntityEvent event) {
        ...
        if (nmsEntity instanceof EntityVillagerAbstract && nmsDamager instanceof CustomEntityZombieVillager) { /* up to 60 max health (80 after 12 attacks), zombie villagers gain 3 max health and health when hitting a villager */
            ...
            nmsZombieVillager.increaseAttacks(1); /* zombie villagers' attack counts increase when attack villagers as well */
