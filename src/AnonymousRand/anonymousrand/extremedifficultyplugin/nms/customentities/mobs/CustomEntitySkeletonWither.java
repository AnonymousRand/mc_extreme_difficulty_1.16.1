...
public class CustomEntitySkeletonWither extends EntitySkeletonWither implements ICustomHostile, IAttackLevelingMob, IGoalRemovingMob {
    ...
    public void initPathfinder() {
        ...
        this.goalSelector.a(0, new CustomPathfinderGoalBreakBlocksAround(this, 20, 1, 1, 1, 1, true)); /* Breaks most blocks around the mob periodically */
        ...
        this.goalSelector.a(1, new CustomPathfinderGoalSpawnBlocksEntitiesOnMob(this, org.bukkit.Material.SOUL_SOIL, 1, 1, 0, 1, -1.0, false)); /* custom goal that allows wither skeleton to summon soul sand in a 3 by 3 beneath itself constantly */
        this.goalSelector.a(1, new CustomPathfinderGoalSpawnBlocksEntitiesOnMob(this, org.bukkit.Material.WITHER_ROSE, 1, 0, 0, 0, 0, false)); /* custom goal that allows wither skeleton to summon wither roses on itself constantly */
