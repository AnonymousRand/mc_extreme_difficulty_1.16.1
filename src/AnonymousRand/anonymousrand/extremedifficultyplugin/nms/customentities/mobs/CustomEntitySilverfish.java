...
public class CustomEntitySilverfish extends EntitySilverfish implements ICustomHostile, IAttackLevelingMob, IGoalRemovingMob {
    ...
    public void initPathfinder() {
        ...
        this.goalSelector.a(0, new CustomPathfinderGoalTeleportNearTargetYLevel(this, 1.0, random.nextDouble() * 3.0, 0.0075)); /* Occasionally teleports to a spot closer in y-level to its target */
