...
/**
 * A subclass of <code>CustomPathfinderGoalAttackRanged</code> that makes sure the correct item is in the main hand to
 ...
 */
public class CustomPathfinderGoalAttackRangedHandheld<T extends EntityInsentient & IRangedEntity
        & ICustomHostile /* & IAttackLevelingMob*/> extends CustomPathfinderGoalAttackRanged<T> {

    protected final Item weapon;

    public CustomPathfinderGoalAttackRangedHandheld(T goalOwner, Item weapon, int attackCooldown) {
