...
public class SpiderSilverfishSummonMaterialBlock extends BukkitRunnable {
    ...
    public SpiderSilverfishSummonMaterialBlock(EntityInsentient entity, Material material, int radius) {
        this.entity = entity;
