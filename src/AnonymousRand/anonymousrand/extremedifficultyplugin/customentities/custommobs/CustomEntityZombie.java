...
public class CustomEntityZombie extends EntityZombie {
    ...
    public void tick() {
        ...
        if (this.attacks == 15 && !this.a15) { /**after 15 attacks, zombies get regen 2, 16 max health and summon 2 vanilla zombies*/
            ...
            new SpawnLivingEntity(this.getWorld(), new EntityZombie(EntityTypes.ZOMBIE, this.getWorld()), 2, CreatureSpawnEvent.SpawnReason.BEEHIVE, null, this, false, true).run();
        }
