...
public class CustomEntityPillager extends EntityPillager implements ICustomMob {
    ...
    public void initPathfinder() {
        ...
        this.goalSelector.a(2, new CustomPathfinderGoalArrowAttack(this, 1.0, 4, 24.0F)); /** shoots every 4 ticks; uses the custom goal that attacks regardless of the y level (the old goal stopped the mob from attacking even if the mob has already recognized a target via CustomNearestAttackableTarget goal) */
