...
public class CustomEntityZombiePig extends EntityPigZombie implements ICustomMob {
    ...
    public void initPathfinder() {
        ...
        this.goalSelector.a(1, new CustomPathfinderGoalZombieAttack(this, 1.0D, true)); /** uses the custom melee attack goal that attacks regardless of the y level */
