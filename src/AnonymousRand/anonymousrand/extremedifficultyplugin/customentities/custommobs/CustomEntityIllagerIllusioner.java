...
public class CustomEntityIllagerIllusioner extends EntityIllagerIllusioner implements ICommonCustomMethods {
    ...
    public CustomEntityIllagerIllusioner(World world) {
    ...
    protected void initPathfinder() {
        ...
        this.goalSelector.a(5, new CustomEntityIllagerIllusioner.c(this));
        this.goalSelector.a(4, new CustomEntityIllagerIllusioner.d(this, 1.0499999523162842D, 1));
    ...
    class CustomPathfinderGoalIllusionerBlindessSpell extends EntityIllagerWizard.c {
        ...
        public boolean a() { /**can now cast blindness multiple times*/
            return super.a() && CustomEntityIllagerIllusioner.this.getGoalTarget() != null;
        }
        ...
        protected void j() { /**only applies blindness for 5 seconds (7.5 seconds after 40 attacks)*/
            CustomEntityIllagerIllusioner.this.getGoalTarget().addEffect(new MobEffect(MobEffects.BLINDNESS, CustomEntityIllagerIllusioner.this.attacks < 40 ? 100 : 150));
        }
    ...
    class CustomPathfinderGoalIllusionerDuplicationSpell extends EntityIllagerWizard.c {
        ...
        @Override
        public boolean a() {
            return !super.a() ? false : !CustomEntityIllagerIllusioner.this.hasEffect(MobEffects.INVISIBILITY);
        }
        ...
        @Override
        protected void j() {
            CustomEntityIllagerIllusioner.this.addEffect(new MobEffect(MobEffects.INVISIBILITY, 1200));


            for (CustomEntityIllagerIllusionerFake fakeIllusioner : CustomEntityIllagerIllusioner.this.fakeIllusioners) { //reset the fake illusioners
                fakeIllusioner.setHealth(0.0F);
            }

            CustomEntityIllagerIllusioner.this.fakeIllusioners.clear();
            CustomEntityIllagerIllusionerFake fakeIllusioner;

            for (int i = 0; i < (CustomEntityIllagerIllusioner.this.attacks < 10 ? 3 : 4); i++) { /**summons 3 additional fake illusioners that actually shoot arrows as well with varying speeds (4 after 10 attacks)*/
                fakeIllusioner = new CustomEntityIllagerIllusionerFake(CustomEntityIllagerIllusioner.this.getWorld(), CustomEntityIllagerIllusioner.this);
                fakeIllusioner.setPosition(CustomEntityIllagerIllusioner.this.locX(), CustomEntityIllagerIllusioner.this.locY(), CustomEntityIllagerIllusioner.this.locZ());
                CustomEntityIllagerIllusioner.this.getWorld().addEntity(fakeIllusioner);
                CustomEntityIllagerIllusioner.this.fakeIllusioners.add(fakeIllusioner);
            }
        }
    ...
    public class c extends PathfinderGoal { //from EntityRaider.java
        ...
        private final CustomEntityIllagerIllusioner illusioner;

        public c(CustomEntityIllagerIllusioner entityraider) {
        ...
        public void e() {
            if (!this.illusioner.isSilent() && this.illusioner.getRandom().nextInt(100) == 0) {
                CustomEntityIllagerIllusioner.this.playSound(CustomEntityIllagerIllusioner.this.eM(), CustomEntityIllagerIllusioner.this.getSoundVolume(), CustomEntityIllagerIllusioner.this.dG());
            }
