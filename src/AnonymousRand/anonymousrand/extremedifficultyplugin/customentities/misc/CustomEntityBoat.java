...
public class CustomEntityBoat extends EntityBoat {
    ...
    protected boolean q(Entity entity) {
        return this.getPassengers().size() < 2 && !this.a(TagsFluid.WATER) && entity instanceof EntityPlayer; /** only players can get in boats (to prevent trapping troublesome mobs like endermen in boats) */
    }
}
