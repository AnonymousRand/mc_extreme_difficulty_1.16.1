...
public class CustomEntityLlamaSpit extends EntityLlamaSpit {
    ...
    protected void a(MovingObjectPositionEntity movingobjectpositionentity) {
        ...
        if (entity instanceof EntityLiving) {
            movingobjectpositionentity.getEntity().damageEntity(DamageSource.a((Entity) this, (EntityLiving) entity).c(), (float)this.damage); /**llama spit does at least 14 damage*/
        }
