...
public class CustomEntityZombieThor extends EntityZombie { // todo expend custom zombie?
    ...
    public void initPathfinder() { /* no longer targets iron golems, villagers or turtles */
        ...
        this.goalSelector.a(0, new NewPathfinderGoalTeleportNearTarget(this, this.getFollowRange(), 300.0, 0.004)); /* Occasionally teleports to a spot near its target */
