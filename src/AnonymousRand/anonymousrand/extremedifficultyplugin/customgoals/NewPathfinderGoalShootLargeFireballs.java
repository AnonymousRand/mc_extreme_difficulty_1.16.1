...
public class NewPathfinderGoalShootLargeFireballs extends PathfinderGoal {
    ...
    public NewPathfinderGoalShootLargeFireballs(JavaPlugin plugin, EntityInsentient entity, int attackCooldown, int intYield, boolean summonLightning) {
        this.plugin = plugin;
        this.entity = entity;
    ...
    public void e() {
        if (this.entity.ticksLived % this.attackCooldown == 11) {
            ...
            CustomEntityLargeFireball entitylargefireball = new CustomEntityLargeFireball(this.plugin, this.entity.getWorld(), this.entity, d2, d3, d4, this.intYield, this.summonLightning);
