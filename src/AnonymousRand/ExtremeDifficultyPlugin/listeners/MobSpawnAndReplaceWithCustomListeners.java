        ...
        if (!(nmsEntity instanceof CustomEntityBat ||
            ...
            switch (event.getEntityType()) {
                ...
                case EVOKER:
                    ...
                    CustomEntityEvoker newEvoker = new CustomEntityEvoker(nmsWorld, this.plugin);
                ...
                case GHAST:
                    ...
                    CustomEntityGhast newGhast = new CustomEntityGhast(nmsWorld, this.plugin);
                ...
                case RABBIT:
                    ...
                    for (int i = 0; i < 10; i++) { /**all rabbits are spawned in as 10 killer bunnies instead*/
                        ...
                        newRabbit.addEffect(new MobEffect(MobEffects.FASTER_MOVEMENT, Integer.MAX_VALUE, 2)); /**changing attributes don't work on rabbits so killer bunnies have speed 3 and jump boost 1*/
                ...
                case SKELETON:
                    if (event.getSpawnReason() != CreatureSpawnEvent.SpawnReason.DROWNED) {
                        ...
                        CustomEntitySkeleton newSkeleton = new CustomEntitySkeleton(nmsWorld, this.plugin);
