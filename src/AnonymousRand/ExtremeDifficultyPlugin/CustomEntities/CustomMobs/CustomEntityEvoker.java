...
import AnonymousRand.ExtremeDifficultyPlugin.BukkitRunnables.EntityRunnables.EvokerStopPlayer;
    ...
    public class WololoSpellGoal extends EntityIllagerWizard.c {
        ...
        protected void j() {
            ...
            if (entitysheep != null && entitysheep.isAlive()) { /**instead of turning sheep red, the evoker summons a hyper-aggressive pink sheep*/
                ...
                new SpawnLivingEntity(entitysheep.getWorld(), newSheep, 1, null, null, entitysheep, true, true).run();
